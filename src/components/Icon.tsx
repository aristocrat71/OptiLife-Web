 ...
 * (24px grid, 2px rounded stroke, currentColor). No emojis.
 */
const PATHS: Record<IconName, ReactNode> = {
  ...
  star: (
    <path d="M11.5 2.6a.55.55 0 0 1 1 0l2.4 4.9 5.4.8a.55.55 0 0 1 .3.93l-3.9 3.8.92 5.36a.55.55 0 0 1-.8.58L12 17.4l-4.82 2.54a.55.55 0 0 1-.8-.58l.92-5.36-3.9-3.8a.55.55 0 0 1 .3-.93l5.4-.8z" />
  ),
  sprout: (
    <>
      <path d="M7 20h10" />
  ...
  sparkles: (
    <>
      <path d="M9.9 15.5A2 2 0 0 0 8.5 14.1l-6.1-1.6a.5.5 0 0 1 0-1l6.1-1.5A2 2 0 0 0 9.9 8.5l1.6-6.1a.5.5 0 0 1 1 0L14 8.5a2 2 0 0 0 1.4 1.4l6.1 1.6a.5.5 0 0 1 0 1L15.5 14a2 2 0 0 0-1.4 1.4l-1.6 6.1a.5.5 0 0 1-1 0z" />
      <path d="M20 3v4" />
      <path d="M22 5h-4" />
      <path d="M4 17v2" />
      <path d="M5 18H3" />
  ...
  rocket: (
    <>
      ...
      <path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.9 12.9 0 0 1 22 2c0 2.7-.8 7.5-6 11a22.4 22.4 0 0 1-4 2z" />
